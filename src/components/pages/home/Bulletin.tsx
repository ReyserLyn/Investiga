...
export default function Bulletin() {
  return (
    <section className="w-full flex justify-center">
      <div className="w-full container px-6 flex flex-col mx-6 bg-primary-black rounded-2xl items-center gap-2 py-24 my-24 relative overflow-hidden">
        ...
        <span className="text-primary-foreground text-lg text-center md:w-[60%] px-3">
          Suscríbete para recibir las últimas noticias y recursos sobre nuestros
          cursos de investigación científica y herramientas impulsadas por IA.
        </span>
        ...
        <div className="bg-primary-foreground rounded-xl px-2 py-2 flex gap-2 mt-10  items-center ">
          ...
          <Button
            variant="secondary"
            className="rounded-xl px-10 text-base h-auto py-3"
          >
            Enviar
          </Button>
        </div>
